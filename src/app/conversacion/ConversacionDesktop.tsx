    ...
    <div className="h-[calc(100vh-2rem)] w-full text-white p-6 grid grid-cols-12 gap-6 overflow-hidden">
      ...
      <main className="col-span-8 flex flex-col gap-6 h-full min-h-0">
                        ...
                        <div key={idx} className={cn("flex flex-col w-full max-w-[85%] mb-2", isSelf ? "ml-auto items-end" : "mr-auto items-start")}>
                          ...
                          <div className={cn("p-5 rounded-3xl shadow-lg relative group", isSelf ? "bg-primary/90 text-white rounded-tr-md" : "bg-white/10 text-white rounded-tl-md")}>
                            ...
                            <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/20">
                              <p className="text-xs opacity-70 italic pr-4">
                    ...
                    chronologicalHistory.map((item, idx) => {
                      ...
                      return (
                        <div key={idx} className={cn("flex flex-col w-full max-w-[85%] mb-2", isSelf ? "ml-auto items-end" : "mr-auto items-start")}>
                          ...
                          <div className={cn("p-6 rounded-3xl shadow-lg relative group", isSelf ? "bg-secondary/90 text-white rounded-tr-md" : "bg-white/10 text-white rounded-tl-md")}>
                            <div className="flex items-center justify-between">
                              <p className="text-2xl font-medium leading-relaxed pr-4">
                            ...
                            <div className="flex items-center justify-between mt-3 pt-3 border-t border-white/20">
                              <p className="text-base opacity-70 italic pr-4">
        ...
        <div className="relative">
          ...
          <div className="flex items-center gap-4 relative z-10 flex-col items-center">
          {logic.isPreparingMic && (
            <motion.div 
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: 10 }}
              className="text-[12px] font-bold text-amber-500 bg-amber-500/10 px-5 py-2 rounded-full uppercase tracking-widest animate-pulse border border-amber-500/20 shadow-[0_0_15px_rgba(245,158,11,0.2)] mb-4"
            >
              Preparando...
            </motion.div>
          )}
