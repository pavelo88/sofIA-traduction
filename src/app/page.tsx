  ...
  const handleKittenChat = async () => {
    ...
    try {
      ...
      if (error.message?.includes('403') || error.message?.includes('blocked')) {
        setKittenResponse("¡Miau! 😿 Mi cerebro espacial está bloqueado. Por favor, activa la 'Generative Language API' en tu consola de Google Cloud para que pueda responderte.");
      } else {
